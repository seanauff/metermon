...
| RTLAMR_MSGTYPE    |scm, scm+|List of message types to listen for. Currently only scm, scm+, idm supported. See [rtlamr config](https://github.com/bemasher/rtlamr/wiki/Configuration)|
